   ...
   <Container>
    <div className="flex items-center justify-between gap-x-20  py-10 ">
        ...
        <div className="flex  justify-center  flex-col  items-right gap-2 mt-8">
            ...
            <a href="https://noormohammad.reactbd.com/static/media/Noor%20Mohammad%20resume.53c502fbe428d53402e1.pdf" target="blank" className="font-bold text-xl text-blue-800  w-20 h-12 bg-slate-400  flex items-center justify-center rounded-lg hover:bg-black hover:text-white duration-300" > Hire Me </a>
        </div>
    </div>
   </Container> 
  )
