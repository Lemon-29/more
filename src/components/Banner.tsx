   ...
   <Container className="">
    <div className="flex items-center justify-between gap-x-20  py-10 ">
        <div className="flex items-center justify-center">
           <Image src={banneri}  alt="my image" className="object-contain h-[400px] w-[2000px] border border-blue-200 shadow-xl shadow-black hover:shadow-gray-600 duration-300 rounded-xl bg-slate-200"/>
        </div>
        <div className="flex  justify-center  flex-col  items-right gap-2 mt-8">
            ...
            <a href="/resume.pdf" target="blank" className="font-bold text-xl text-blue-800  w-20 h-12 mt-2 bg-slate-400  flex items-center justify-center  rounded-lg hover:bg-black hover:text-white duration-300" > Hire Me </a>
        </div>
    </div>
   </Container> 
  ) 
